...
func TestRegisterAndLogin(t *testing.T) {
	...
	// Register: ожидаем вставку и возвращаем успех
	mock.ExpectExec("INSERT INTO users").WithArgs(sqlmock.AnyArg(), "testuser", []byte("encrypted")).WillReturnResult(sqlmock.NewResult(1, 1))
	...
	// Проверим, что все ожидания выполнены
